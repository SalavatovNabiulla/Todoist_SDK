...
#Область Комментарии
Функция ПолучитьСписокВсехКомментариев(Данные) Экспорт
...
КонецФункции
//
Функция СоздатьНовыйКомментарий(Данные) Экспорт
...
#Область Другое
Функция ПолучитьСтруктуруДанных(НомерШаблона = 0) Экспорт
	Шаблон = Новый Структура;
	//
	Если НомерШаблона = 0 Тогда // Проект
	...
	ИначеЕсли НомерШаблона = 1 Тогда // Секция
		Шаблон.Вставить("Идентификатор",Неопределено);
		Шаблон.Вставить("ИдентификаторПроекта",Неопределено);
		Шаблон.Вставить("ПорядковыйНомер",Неопределено);
		Шаблон.Вставить("Название",Неопределено);
	ИначеЕсли НомерШаблона = 2 Тогда // Задача
		...
		Шаблон.Вставить("ИдентификаторРодителя",Неопределено);
		Шаблон.Вставить("Ссылка",Неопределено);
	ИначеЕсли НомерШаблона = 3 Тогда // Комментарий
		Шаблон.Вставить("Содержание",Неопределено);
		Шаблон.Вставить("Идентификатор",Неопределено);
	...
	ИначеЕсли НомерШаблона = 4 Тогда // Личная метка
		Шаблон.Вставить("Идентификатор",Неопределено);
		Шаблон.Вставить("Название",Неопределено);
		Шаблон.Вставить("Цвет",Неопределено);
		Шаблон.Вставить("ПорядковыйНомер",Неопределено);
		Шаблон.Вставить("Избранное",Неопределено);
	ИначеЕсли НомерШаблона = 5 Тогда // Общая метка
		Шаблон.Вставить("Название",Неопределено);
